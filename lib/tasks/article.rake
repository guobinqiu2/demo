#rake articles:add_to_cache RAILS_ENV=development
namespace :article do
  ...
  task :import => :environment do
    Article.destroy_all
    #Article.delete_all
    1000.times {Article.create(title: 'green', text: 'green', author: 'Guobin', email: 'qracle@126.com', email_confirmation:'qracle@126.com', state: 1)}
